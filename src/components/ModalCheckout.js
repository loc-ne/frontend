...
const ModalCheckout = ({ onClose }) => {
    ...
    return (
                ...
                <div className="brutalist-card__header">
                    <div className="brutalist-card__icon">
                        ...
                        <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                            <path className="st0" d="M198.746,439.89c-5.698-3.854-12.636-6.128-20.013-6.119c-4.912,0-9.651,1-13.943,2.82
		...
		c1.555,2.315,2.456,5.028,2.456,8.054C193.155,471.587,192.758,473.456,192.03,475.176z"/>
                            <path className="st0" d="M168.726,392.844c-3.87,0-7.492-0.777-10.816-2.175c-4.962-2.1-9.246-5.64-12.239-10.089
		...
		c-7.278,2.133-14.902-2.051-17.036-9.328l-35.576-121.812C161.796,145.39,165.964,137.766,173.25,135.64z"/>
                            <path className="st0" d="M421.604,324.561c-49.932,0-90.396,40.472-90.396,90.404c0,49.924,40.464,90.396,90.396,90.396
		...
		l22.427,17.945l37.784-48.576l20.733,16.118L416.478,457.19z"/>
                    ...
                    <div className="brutalist-card__alert">Checkout Required</div>
                ...
                <div className="brutalist-card__message">
                    To proceed with your checkout, please log in to your account. This helps us provide a secure and personalized shopping experience. Thank you!
                </div>
                <div className="brutalist-card__actions">
                    <Link to="/account?from=checkout&register=true"><a className="brutalist-card__button brutalist-card__button--mark" href="#"
                    >REGISTER</a
                    ></Link>
                    <Link to="/account?from=checkout&login=true"><a className="brutalist-card__button brutalist-card__button--read" href="#"
                    >LOGIN HERE</a
                    ></Link>
                </div>
            </div>
